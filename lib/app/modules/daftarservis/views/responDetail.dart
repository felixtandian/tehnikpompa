...
class ResponDetail extends GetView<DaftarservisController> {
  ...
  Widget build(BuildContext context) {
    if (controller.jmlPompaTeknisi.text.isEmpty) {
      var pompalength = 0;
    } else {
      var pompalength = int.parse(controller.jmlPompaTeknisi.text);
    }
    var i = controller.p.value;
    // TODO: implement build
    return WillPopScope(
        onWillPop: () async {
          MessageUtils.success(text: 'Mohon Selesaikan terlebih dahulu.');
          return false;
        },
        child: Scaffold(
            appBar: AppBar(
                ...
                child: Obx(
                  () => Column(
                    children: [
                      ...
                      Text(
                        'Pompa no ' +
                            controller.p.value.toString() +
                            '/' +
                            controller.jmlPompaTeknisi.text,
